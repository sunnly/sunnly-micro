package wang.sunnly.micro.security.core.utils.jwt;
...
public class JWTHelper {
    ...
    public static IJWTInfo getInfoFromToken(String token, String pubKeyPath) throws Exception {
        ...
        return new JWTInfo(body.getSubject(), Objects.toString(body.get(CommonConstants.JWT_KEY_USER_ID),""), Objects.toString(body.get(CommonConstants.JWT_KEY_NAME),""));
    }
    /**
     * 获取token中的用户信息
     *
